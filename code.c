...
// Поиск платформ с низкой задержкой (< 50 мс)
...
// Поиск платформ с поддержкой MQTT
...
// Поиск бюджетных платформ (< $1 за устройство)
...
// Поиск платформ с высокой масштабируемостью
